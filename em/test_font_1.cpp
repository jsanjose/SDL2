...
public:
	...
	int loadFont(string fontFileName, int fontSize) {
		if (!fontFileName.empty()) {
			cout << "FUENTE: " << fontPath << fontFileName << endl;
...
EM_BOOL one_iter(double time, void *userData) {
	if (!processEvents()) return EM_FALSE;
...
//--> emcc .\test_font_1.cpp -sUSE_SDL=2 -sUSE_SDL_TTF=2 -o testfont1.html --embed-file .\ttf\